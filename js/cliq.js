$(document).ready(function(){
  ...
  $("img.cliq").animate({"margin-top":"12px","opacity":1},1500)
  if($(window).width()<576){
    $("img.cliq").animate({"margin-top":"10px","opacity":1},1500)
  }
  ...
  function show45(){
    count_45++;
    if(count_45%2==1){
      $("#sec3 i").css({"transform":"translate(-50%,-38px) rotate(45deg)","background":"black","border":"none"})
    ...
    if(count_45%2==0){
      $("#sec3 i").css({"transform":"translate(-50%,-100%) rotate(0deg)","background":"none","border":"1px solid white"})
      $(".45hide").css({"height":"0"});
      setTimeout(function(){
  ...
  function show78(){
    count_78++;
    if(count_78%2==1){
      $("#sec6 i").css({"transform":"translate(-50%,-38px) rotate(45deg)","background":"black","border":"none"})
    ...
    if(count_78%2==0){
      $("#sec6 i").css({"transform":"translate(-50%,-100%) rotate(0deg)","background":"none","border":"1px solid white"})
      $(".78hide").css({"height":"0"});
      setTimeout(function(){
  ...
  function show11(){
    count_11++;
    if(count_11%2==1){
      $("#sec10 i").css({"transform":"translate(-50%,-38px) rotate(45deg)","background":"black","border":"none"})
    ...
    if(count_11%2==0){
      $("#sec10 i").css({"transform":"translate(-50%,-100%) rotate(0deg)","background":"none","border":"1px solid white"})
      $(".11hide").css({"height":"0"});
      setTimeout(function(){
  ...
  function show1314(){
    count_1314++;
    if(count_1314%2==1){
      $("#sec12 i").css({"transform":"translate(-50%,-38px) rotate(45deg)","background":"black","border":"none"})
    ...
    if(count_1314%2==0){
      $("#sec12 i").css({"transform":"translate(-50%,-100%) rotate(0deg)","background":"none","border":"1px solid white"})
  ...
  $("#sec12 .textwrap").click(function(){
    show1314()
  })
  $("#sec12 .mobile p,h4").click(function(){
    show1314()
  })
